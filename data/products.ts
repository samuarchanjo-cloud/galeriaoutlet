...
export const products: Product[] = [
  ...
  product("shorts-3", "Bermuda Sarja Nike", "shorts", "bermuda-3.png", 69.9, "Shorts casual com acabamento caprichado e toque agradável."),
  product("shorts-4", "Bermuda Elastano Nike", "shorts", "bermuda-4.png", 79.9, "Modelo urbano para compor looks confortáveis e modernos."),
